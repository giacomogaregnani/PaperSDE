...
\begin{theorem}\label{thm:mainTheorem} Under the assumptions of Lemma \ref{lem:ergodicity} and Lemma \ref{lem:convMeasure}, let $\widehat A^\epl_k(T)$ be defined in \eqref{eq:AHatMixed}. Then
	\begin{equation}
...
\begin{figure}[t]
	...
	\end{tabular}
	\caption{Results for the four-dimensional parameters. From left to right the potential function estimated with the data itself, the filter, subsampled data.}
	\label{fig:KLStyle}
\end{figure}

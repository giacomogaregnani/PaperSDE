...
\end{equation}
The following theorem guarantees the unbiasedness of this estimator under a condition on the parameter $\delta$ of the filter, and we refer to the Appendix for its proof.
...
\begin{table}[ht!]
	...
	\begin{tabular}{cccccc}
		...
		\bottomrule
	\end{tabular}
	\caption{Numerical results for the four-dimensional parameter rounded to the second significant digit.}
	\label{tab:KLStyle}
\end{table}

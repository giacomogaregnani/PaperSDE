...
\subsection{Failure without pre-processing \corr{rewrite}}
...
\begin{remark} Let us remark that in the one-dimensional case $N = 1$, the estimator reduces to
\begin{equation}
...
\begin{aligned}
	...
	&= -\int_{\R} \int_{\R} V'(z) \left ( \frac{1}{C_{\phi^0}} e^{-\frac{1}{\Sigma} A\cdot V(x)} \right )' \psi^0(z) R^0(x,z) \dd x \dd z \\

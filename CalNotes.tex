...
\begin{proof}
	...
	\end{equation}
	where $\widetilde{\mathcal M}_\epl$ is defined in \eqref{eq:DefMTilde}.	Then following the proof of Theorem \ref{thm:mainTheorem} and in light of Remark \ref{rem:deltaPower}, we only need to show that if $\delta = \epl^\zeta$ with $\zeta \in (0,2)$ we have
	\begin{equation}
